...
class HomePage extends BasePage {
    constructor(page){
        ...
        super(page);
        //selectors
        this.productTitle = page.selector('body > y42-root > y42-navigation > mat-sidenav-container > mat-sidenav-content > div > y42-products > div > y42-product-list > ag-grid-angular > div > div.ag-root-wrapper-body.ag-layout-normal.ag-focus-managed > div.ag-root.ag-unselectable.ag-layout-normal > div.ag-body-viewport.ag-layout-normal.ag-row-animation > div.ag-center-cols-clipper > div > div > div.ag-row-even.ag-row-no-focus.ag-row.ag-row-level-0.ag-row-position-absolute.ag-row-first > div:nth-child(1)');
