...
class HomePage extends BasePage {
    ...
    async updateAssetCpt(titleValue, brandValue, descriptionValue) {
        ...
        const fruits = [this.descriptionField, this.titleField,  this.priceField, this.stockField];
        fruits.forEach(async function(element){await  peido.press(element, 'Control+A+Backspace' )});
