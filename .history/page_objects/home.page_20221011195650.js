...
class HomePage extends BasePage {
    ...
    async updateAssetCpt(titleValue, brandValue, descriptionValue) {
        const peido = this.page
        ...
        const fruits = [ this.descriptionField, this.priceField, this.stockField, this.titleField];
        fruits.forEach(async function(element){peido.press(element, 'Control+A+Backspace', {slowMo: 200})});
